        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            ...
            <section class="content">
                <div class="container-fluid mt-5">
                    ...
                    <div class="row">
                        <div class="col-md-7 m-auto border border-dark p-5 m-0" style="background-color:#C0C0C0">
                            

                                <h3 class="m-auto text-center text-white">Set up Google Authenticator </h3>
