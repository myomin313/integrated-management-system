      <div class="modal fade" id="change_request">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{route('dashboard.change-request')}}" method="post" class="prevent-multiple-submit-modal">
              @csrf
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date" id="changing_date" data-target-input="nearest">
                    <input type="text" name="changing_date" id="changing_date" required placeholder="dd/mm/YYYY" class="form-control datetimepicker-input" data-target="#changing_date"/>
                    <div class="input-group-append" data-target="#changing_date" data-toggle="datetimepicker">
