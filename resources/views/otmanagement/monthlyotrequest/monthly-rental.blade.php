                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    @foreach($otsummaries as $user=>$otsummary)
                      <tr>
                        ...
                        @php
                          ...
                          $overtime_net_total += $overtime_total;
                        ...
                        <td class="text-right">{{siteformat_number($overtime_total)}}</td>
                        <td class="text-right">{{$otsummary['taxi_charge']}}.00</td>
                        <td class="text-right">{{siteformat_number($total)}}</td>
                        @php
                          $exchange_rate = getOTExchangeRate($user,$date);
                          $mmk_amount = $total * $exchange_rate;
                    ...
                    <tr>
                      ...
                      <td class="text-bold text-right">{{siteformat_number($overtime_net_total)}}</td>
                      <td class="text-right text-bold">{{siteformat_number($total_taxi)}}</td>
                      <td class="text-bold text-right">{{siteformat_number($net_total)}}</td>
