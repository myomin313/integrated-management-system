                          ...
                          <table id="transfer_to_info">
                            ...
                            <tfoot>
                              <tr>
                                ...
                                <td>
                                  <strong id="transfer_to_usd_label">0</strong>
                                  <input type="hidden" class="form-control" id="transfer_to_usd" name="transfer_to_usd" value="0">
                                </td>
                                <td>
                                  <strong id="transfer_to_mmk_label">0</strong>
                                  <input type="hidden" class="form-control" id="transfer_to_mmk" name="transfer_to_mmk" value="0">
                                </td>
                          ...
                          <table id="transfer_from_info">
                            ...
                            <tfoot>
                              <tr>
                                ...
                                <td>
                                  <strong id="transfer_from_usd_label">0</strong>
                                  <input type="hidden" class="form-control" id="transfer_from_usd" name="transfer_from_usd" value="0">
                                </td>
                                <td>
                                  <strong id="transfer_from_mmk_label">0</strong>
                                  <input type="hidden" class="form-control" id="transfer_from_mmk" name="transfer_from_mmk" value="0">
                                </td>
                          ...
                          <table id="electricity_info">
                            ...
                            <tfoot>
                              <tr>
                                ...
                                <td>
                                  <strong id="electricity_usd_label">0</strong>
                                  <input type="hidden" class="form-control" id="electricity_usd" name="electricity_usd" value="0">
                                </td>
                                <td>
                                  <strong id="electricity_mmk_label">0</strong>
                                  <input type="hidden" class="form-control" id="electricity_mmk" name="electricity_mmk" value="0">
                                </td>
                          ...
                          <table id="car_info">
                            ...
                            <tfoot>
                              <tr>
                                ...
                                <td>
                                  <strong id="car_usd_label">0</strong>
                                  <input type="hidden" class="form-control" id="car_usd" name="car_usd" value="0">
                                </td>
                                <td>
                                  <strong id="car_mmk_label">0</strong>
                                  <input type="hidden" class="form-control" id="car_mmk" name="car_mmk" value="0">
                                </td>
                            ...
                            <tfoot>
                              <tr>
                                ...
                                <td>
                                  ...
                                  <input type="hidden" class="form-control" id="bonus_usd" name="bonus_usd" value="3">
                                </td>
                                <td>
