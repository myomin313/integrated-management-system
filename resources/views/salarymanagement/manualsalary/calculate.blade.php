          ...
          <div class="col-8 m-auto">
            ...
            <div class="card" style="padding:20px;">
              <div class="card-header">
                <h3 class="card-title">Add Salary (April, 2023)</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{route('add-salary.store')}}" method="post" id="create_user" class="prevent-multiple-submit">
                  @csrf
                  ...
                  <div class="form-group ">
                      ...
                      <div class="input-group date" data-target-input="nearest">
                          <input type="text" name="year" id="year" required placeholder="YYYY" value="2023" readonly class="form-control datetimepicker-input" data-target="#datetimepicker"/>
                  ...
                  <div class="form-group ">
                      ...
                      <div class="input-group date" data-target-input="nearest">
                          <input type="text" name="month" id="month" required placeholder="Month" value="April" readonly class="form-control datetimepicker-input" data-target="#datetimepicker1"/>
