                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      @php
                        ...
                        $total_ot_payment = $old_salary->previous_normal_ot_payment_usd + $old_salary->previous_taxi_charge_usd;
                      @endphp
                      <div class="form-group row">
                        <label for="ot_rate_usd" class="col-sm-4 col-form-label">OT Rate ($) </label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="ot_rate_usd" name="ot_rate_usd"value="{{$ot_payment}}" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="previous_total_ot_payment" name="previous_total_ot_payment" value="{{$old_salary->previous_normal_ot_payment_usd}}" onkeyup="calculateOTAmount()" onchange="calculateOTAmount()">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="previous_taxi_charge_usd" name="previous_taxi_charge_usd" value="{{$old_salary->previous_taxi_charge_usd}}"  onkeyup="calculateOTAmount()" onchange="calculateOTAmount()">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="input-group col-sm-8" data-target-input="nearest">
                          <input type="text" class="form-control" id="unpaid_leave_day" name="unpaid_leave_day" value="{{$old_salary->unpaid_leave_day}}" onkeyup="calculateLeaveAmount()" onchange="calculateLeaveAmount()">
                          <div class="input-group-append">
