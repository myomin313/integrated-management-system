        ...
        <div class="row mb-2">
          <div class="col-sm-8">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="{{url('salary-management/payslip-list/bank')}}">Pay List (Bank)</a></li>
            </ol>
          </div><!-- /.col -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <form action="{{url('salary-management/payslip-list/bank')}}" method="get">
                  @php
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group" style="margin-top: 37px;">
                          ...
                          <a href="{{url('salary-management/payslip-list/bank')}}" class="btn btn-warning text-white">Reset</a>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-sm-6">
                    <h3 class="card-title">Pay List (Bank)</h3>
                  </div>
                  <div class="col-sm-6 text-right">
                    <a href="{{route('salary.bank-download',['from_date'=>isset($from_date)?$from_date:$today_date,'to_date'=>isset($to_date)?$to_date:$today_date,'employee'=>isset($employee)?$employee:'all'])}}" class="btn btn-success text-white breadcrumb-btn"><i class="fas fa-download"></i> Export</a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
                  ...
                  <tbody>
                    ...
                    @foreach($paylists as $key=>$value)
                      <tr>
                        ...
                        @endphp
                      	<td>{{$emp_name}}<br>{{$bank_name?'('.$bank_name.')':''}}</td>
                        
                        <td>{{getNSFieldWithId($value->user_id,"nrc_no")}}</td>
                        <td>{{getUserFieldWithId($value->user_id,"bank_account_mmk")}}</td>
