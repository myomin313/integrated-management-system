                ...
                <form action="{{route('salary-form.store')}}" method="post" id="create_user" class="prevent-multiple-submit">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                          ...
                          <table>
                            <tr>
                              <td>
                                ...
                                <input type="text" class="form-control" id="previous_normal_ot_hr" name="previous_normal_ot_hr" value="{{$ot_hr->normal}}" readonly>
                              </td>
                              <td>
                                <strong>Saturday</strong><br>
                                <input type="text" class="form-control" id="previous_sat_ot_hr" name="previous_sat_ot_hr" value="{{$ot_hr->saturday}}" readonly>
                              </td>
                              <td>
                                <strong>Sunday</strong><br>
                                <input type="text" class="form-control" id="previous_sun_ot_hr" name="previous_sun_ot_hr" value="{{$ot_hr->sunday}}" readonly>
                              </td>
                              <td>
                                <strong>P/Holiday</strong><br>
                                <input type="text" class="form-control" id="previous_public_holiday_ot_hr" name="previous_public_holiday_ot_hr" value="{{$ot_hr->public_holiday}}" readonly>
                              </td>
                            </tr>
                          </table>
                        ...
                        <div class="col-sm-8">
                          <table>
                            <tr>
                              <td>
                                <strong>Weekday</strong><br>
                                <input type="text" class="form-control" id="current_normal_ot_hr" name="current_normal_ot_hr" value="{{$current_ot_hr->normal}}" readonly>
                              </td>
                              <td>
                                <strong>Saturday</strong><br>
                                <input type="text" class="form-control" id="current_sat_ot_hr" name="current_sat_ot_hr" value="{{$current_ot_hr->saturday}}" readonly>
                              </td>
                              <td>
                                <strong>Sunday</strong><br>
                                <input type="text" class="form-control" id="current_sun_ot_hr" name="current_sun_ot_hr" value="{{$current_ot_hr->sunday}}" readonly>
                              </td>
                              <td>
                                <strong>P/Holiday</strong><br>
                                <input type="text" class="form-control" id="current_public_holiday_ot_hr" name="current_public_holiday_ot_hr" value="{{$current_ot_hr->public_holiday}}" readonly>
                              </td>
                            </tr>
                          </table>
                      ...
                      @php 
                      $previous_ot_hr = sumTime([$ot_hr->normal , $ot_hr->saturday , $ot_hr->sunday , $ot_hr->public_holiday]);
                      $previous_current_ot_hr = sumTime([sumTime([$ot_hr->normal , $ot_hr->saturday , $ot_hr->sunday , $ot_hr->public_holiday]) , sumTime([$current_ot_hr->normal , $current_ot_hr->saturday , $current_ot_hr->sunday , $current_ot_hr->public_holiday])]);
                      @endphp
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="total_ot_hr" name="total_ot_hr" value="{{sumTime([$ot_hr->normal , $ot_hr->saturday , $ot_hr->sunday , $ot_hr->public_holiday])}}" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      @php
                        ...
                        $current_normal_payment = getOTAmount($current_ot_hr->normal, $ot_payment);
                        $current_sat_payment = getOTAmount($current_ot_hr->saturday, $ot_payment);
                        $current_sun_payment = getOTAmount($current_ot_hr->sunday, $ot_payment);
                        $current_public_payment = getOTAmount($current_ot_hr->public_holiday, $ot_payment);

                        $current_taxi_charge = getTaxiCharge($user->id,siteformat_date($current_month.'-01'));
                          ...
                          <table id="ot_info">
                            ...
                            <tfoot>
                              <tr>
                                ...
                                <td>
                                  <strong id="ot_usd_label">{{round_up_nodecimal($total_ot_payment)}}</strong>
                                  <input type="hidden" class="form-control" id="ot_usd" name="ot_usd" value="{{round_up_nodecimal($total_ot_payment)}}">
                                </td>
                                <td>
                                  <strong id="ot_mmk_label">{{$mmk_amount}}</strong>
                                  <input type="hidden" class="form-control" id="ot_mmk" name="ot_mmk" value="{{$mmk_amount}}">
                                </td>
                                <td>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="input-group col-sm-8" data-target-input="nearest">
                          <input type="text" class="form-control" id="unpaid_leave_day" name="unpaid_leave_day" value="{{$total_leave_day}}" readonly>
                          <div class="input-group-append">
                          ...
                          <table id="leave_info">
                            ...
                            <tfoot>
                              <tr>
                                ...
                                <td>
                                  <strong id="leave_usd_label">{{$leave_amount}}</strong>
                                  <input type="hidden" class="form-control" id="leave_usd" name="leave_usd" value="{{$leave_amount}}">
                                </td>
                                <td>
                                  <strong id="leave_mmk_label">{{$mmk_amount}}</strong>
                                  <input type="hidden" class="form-control" id="leave_mmk" name="leave_mmk" value="{{$mmk_amount}}">
                                </td>
                                <td>
