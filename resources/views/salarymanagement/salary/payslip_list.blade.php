        ...
        <div class="row mb-2">
          <div class="col-sm-8">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="{{url('tax-management/ssc-report')}}">Payslip List</a></li>
            </ol>
          </div><!-- /.col -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <form action="{{url('salary-management/payslip-list/detail')}}" method="get">
                  @php
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group" style="margin-top: 37px;">
                          ...
                          <a href="{{url('salary-management/payslip-list/detail')}}" class="btn btn-warning text-white">Reset</a>
              ...
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-sm-6 text-right">
                    {{-- <a href="{{route('tax.ssc-report',['from_date'=>isset($from_date)?$from_date:$today_date,'to_date'=>isset($to_date)?$to_date:$today_date,'employee'=>isset($employee)?$employee:'all'])}}" class="btn btn-success text-white breadcrumb-btn"><i class="fas fa-download"></i> Export</a> --}}
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
                  ...
                  <tbody>
                    ...
                    @foreach($paylists as $key=>$value)
                      <tr>
                        ...
                        <td class="text-right">{{siteformat_number($value->net_salary_usd)}}</td>
                        <td class="text-right">{{number_format($value->net_salary_mmk)}}</td>
                        
                      	<td>{{siteformat_date($value->pay_date)}}</td>
                      	<td>
                         <a href="{{url('salary-management/payslip-list/detail',[$value->id])}}">
                            <i class="fas fa-arrows-alt text-primary text-bold" style="font-size:15px;"></i>
                          </a> 
                        </td>
