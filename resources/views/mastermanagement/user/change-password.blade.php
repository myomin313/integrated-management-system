...
<head>
    ...
    <title>Change Password - Marubeni</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="row">
                        <div class="col-md-4 m-auto border border-dark p-5 m-0" style="background-color:#C0C0C0">
                            <form method="POST" action="{{ route('user.update-password') }}" class="register-form">
                                @csrf
                                <p class="m-auto text-center text-danger" style="font-size: 18px;font-weight: bold;">You need to change password first </p>
                                <br>
                                <div class="input-group" data-target-input="nearest">
                                    <label for="current_password" class="col-sm-12">Current Password <span class="required text-danger">*</span></label>
                                    <input type="password" class="form-control" id="current_password" name="current_password" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text bg-white" id="current-password-icon" onclick="showCurrentPassword()"><i class="fa fa-eye"></i></div>
                                    </div>
                                </div>
                                <div class="input-group" data-target-input="nearest">
    ...
    <script type="text/javascript">
        ...
        function showCurrentPassword(){
            var className = $("#current-password-icon i").attr('class');
            var lastClass = $('#current-password-icon i').attr('class').split(' ').pop();
            
            if(lastClass=="fa-eye"){
                $("#current-password-icon i").removeClass("fa-eye");
                $("#current-password-icon i").addClass("fa-eye-slash");
                $("#current_password").attr("type","text");
            }
            else{
                
                $("#current-password-icon i").removeClass("fa-eye-slash");
                $("#current-password-icon i").addClass("fa-eye");
