...
@section('title','Add NS Actual Income Taxs')
@section("content")
          ...
          <div class="col-12 m-auto">
            ...
            <div class="card" style="padding:20px;">
              <div class="card-header">
                <h3 class="card-title">Add Actual Income Tax for NS</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{route('ns-tax.store')}}" method="post" id="create_user" class="prevent-multiple-submit">
                  	@csrf
                  	<div class="row">
                        
                        <table class="table" id="ns_tax_records">
                            <thead>
                            	<tr>
                            		<th>No.</th>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div class="delete-row btn btn-danger remove" onclick="delete_Row_NsTax(this)" title="Remove row"><i class="fa fa-minus" style="font-size: 14px;font-weight: bold;color: white;"></i></div>
                                </td>
                	...
                	<div class="col-md-12 col-sm-12">
                        <a class="btn btn-success breadcrumb-btn ns-tax-addmore"><i class="fas fa-plus"></i> Add</a>
                    </div>
                  	<div class="form-group text-center">
                    	<button type="submit" class="btn btn-success" name="save_new">Save & New</button>
                    	<button type="submit" class="btn btn-info" name="save">Save</button>
                    	<a href="{{route('ns-tax.list')}}" type="button" class="btn btn-primary">Cancel</a>
...
<script>
    ...
    var n = 0;
    $(".ns-tax-addmore").on("click", function () {
	    count = $("table#ns_tax_records tr").length;
	    var num = get_row_num("table#ns_tax_records");
	    n = Number(num) + 1;
    	var data = '';
    	...
    	data +='<td><div class="delete-row btn btn-danger remove" onclick="delete_Row_NsTax(this)" title="Remove row"><i class="fa fa-minus" style="font-size: 14px;font-weight: bold;color: white;"></i></div></td></tr>';
    	$("table#ns_tax_records tbody").append(data);
    ...
    function delete_Row_NsTax(row) {
  	...
  	function checkNSTax() {
	  obj = $("table#ns_tax_records tbody tr").find("small");
