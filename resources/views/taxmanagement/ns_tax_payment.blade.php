...
@section('title','Actual Tax Payment (NS)')
@section("content")
        ...
        <div class="row mb-2">
          <div class="col-sm-8">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="{{url('tax-management/annual-tax/ns-tax-payment-report')}}">Actual Tax Payment (NS)</a></li>
            </ol>
          </div><!-- /.col -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <form action="{{url('tax-management/annual-tax/ns-tax-payment-report')}}" method="get">
                  @php
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-group" style="margin-top: 37px;">
                          ...
                          <a href="{{url('tax-management/annual-tax/ns-tax-payment-report')}}" class="btn btn-warning text-white">Reset</a>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-sm-6">
                    <h3 class="card-title">Actual Tax Payment (NS)</h3>
                  </div>
                  <div class="col-sm-6 text-right">
                    <a href="{{route('tax.ns-tax-payment-report-download',['from_date'=>isset($from_date)?$from_date:$today_date,'to_date'=>isset($to_date)?$to_date:$today_date,'employee'=>isset($employee)?$employee:'all'])}}" class="btn btn-success text-white breadcrumb-btn"><i class="fas fa-download"></i> Export</a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th>Central Bank Ex Rate</th>
                      <th>Income Tax Total<br>(Kyats)</th>
                      <th>Remark</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    @foreach($income_taxes as $key=>$value)
                      <tr>
                        ...
                        <td>{{getUserFieldWithId($value->user_id,"dob")}}</td>

                        @php
                          $salary = getNsSalary($value->user_id,$value->tax_period);
                        @endphp
                        <td class="text-right">{{siteformat_number($salary)}}</td>
                        ...
                        <td>{{\Carbon\Carbon::parse($value->tax_period)->format("F, Y")}}<br>National Staff</td>
                      	@php
                          $total_salary += $salary;
