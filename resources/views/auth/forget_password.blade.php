...
<head>
    ...
    <title>Forgot Password - Marubeni</title>
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="row">
                        <div class="col-md-4 m-auto border border-dark p-5 m-0" style="background-color:#C0C0C0">
                            <form method="POST" action="{{ route('forget.password.post') }}" class="register-form">
                                @csrf
                                <h4 class="m-auto text-white">Select Your Account </h4>
                                <div class="form-group">
                                    <label for="user_id">User Name <span class="required text-danger">*</span></label>
                                ...
                                <div class="form-group row p-3">
                                    <div class="col-md-12 m-auto text-right">
                                        ...
                                        <a href="{{url('/login')}}" class="btn btn-primary">Cancel</a>
                                    </div>
                                </div>
