                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="row">
                        <div class="col-md-4 m-auto border border-dark p-5 m-0" style="background-color:#C0C0C0">
                            <form method="POST" action="{{ route('otp.post') }}" class="register-form">
                                @csrf
                                <p class="m-auto text-white">{{$message}} </p>
                                <input type="hidden" name="user_id" value="{{$id}}">
                                <div class="form-group">
                                    <label for="code">Code <span class="required text-danger">*</span></label>
