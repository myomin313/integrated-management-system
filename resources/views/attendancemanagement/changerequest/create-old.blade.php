      <div class="modal fade" id="modal-create">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{route('change-request.store')}}" method="post" id="create_form">
              @csrf
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="time">Changing Time<span class="required text-danger">*</span></label>
                  <div class="row">
                    <div class="col-md-6">
                      <!-- <input type="time" class="form-control" id="changing_start_time" name="changing_start_time" required> -->
                      <div class="input-group date" id="timepicker" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input" data-target="#timepicker" id="changing_start_time" name="changing_start_time" required/>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group date" id="timepicker1" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input" data-target="#timepicker1" id="changing_end_time" name="changing_end_time" required/>
