...
class CreateMonthlyOtRequestDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('monthly_ot_request_details', function (Blueprint $table) {
            $table->id();
            $table->integer('monthly_ot_request_id');
            $table->integer('daily_ot_request_id');
            ...
            $table->tinyInteger('daily_request')->default(0);
    ...
    {
        Schema::dropIfExists('monthly_ot_request_details');
    }
}
