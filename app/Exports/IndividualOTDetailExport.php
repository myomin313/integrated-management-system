...
class IndividualOTDetailExport implements FromCollection,WithHeadings,WithStyles,ShouldAutoSize,WithEvents
{
    ...
    */
    public function collection()
    {
        ...
        $data[]=[
            ...
            '',
            '$'.round_up_nodecimal($overtime_net_total)
